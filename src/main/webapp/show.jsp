                     ...
                     success:function(resultData){
                       ...
                       $(resultData).each(function(index,item){
                           ...
                           var newdate = new Date(item.createtime);
                            tr += "<td><ul class='notice-list'> <li class='ue-clear'> <span id='p'> <img src='${pageContext.request.contextPath}/images/tx.png' height='50px' width='50px'/> </span> <font>发布时间："+newdate.getFullYear()+"-"+newdate.getMonth()+1+"-"+newdate.getDate()+"</font> <a href='role.jsp 'class='notice-title'>"+item.forumtitle+"</a> </li> </ul></td>";
                            if(index!=0 && i%3 ==0 ) {
                                var ttr = tr + "</tr>";
                                $("#ff").before(ttr);
                            }
