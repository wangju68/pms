...
<script type="text/javascript">
			...
			success:function(msg){
			    $(msg.map.list).each(function (index,item) {
                	var li = "<li class='ue-clear'>"
                        +"<span>"+moment(item.ndate).format("YYYY-MM-DD")+"</span>&nbsp;&nbsp;&nbsp;<a onclick='noticeAll("+item.nid+")' href='javascript:void(0)'class='notice-title'>"+(item.ntitle)+"</a>"
                        +"</li><p>"
	...
	function noticeAll(obj) {
		$.ajax({
			type:"get",
			url:"notice/selectInfo/"+obj,
			success:function (msg) {
