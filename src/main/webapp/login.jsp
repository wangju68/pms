...
<script type="text/javascript">
    ...
    function change() {
		$("#img").attr("src","code/getCode?time="+new Date());
    }
    function checkLogin() {
		$("#form").submit();
    }
	...
	<DIV>
		<form id="form" action="emp/login" method="get">
			...
			<TBODY>
				...
				<TR>
										...
										<TABLE id=table2 cellSpacing=1 cellPadding=0 width="100%"
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT name="username" class=regtxt title=请填写用户名 maxLength=16
														size=16 id=username></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>密&nbsp;
															码：</FONT></TD>
													<TD><INPUT name="password" class=regtxt title=请填写密码 type=password
														maxLength=16 size=16 id=pass></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>验证码：</FONT></TD>
													<TD>
														<INPUT style="width: 70px" class=regtxt title=请填写验证码 maxLength=50
														 name="codeCheck">
														<img id="img" onclick="change()" style="width: 100px;height: 30px" src="code/getCode?time="<%=new Date()%> alt="">
													</TD>
												</TR>
											</TBODY>
										</TABLE>
					...
					<TD colSpan=2 rowSpan=2>
						<IMG id="checkLogin()" height=158 alt="" src="images/crm_13.gif" width=295></TD>
				...
				<TR>
					...
					<TD><input title=登录项目平台管理系统 type=image height=48 alt=""
						width=86 src="images/crm_17.gif" name="image" onclick="checkLogin()"></TD>
