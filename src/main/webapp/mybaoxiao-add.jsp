...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input id="buildTime" type="text" name="bxtime"/>
		<img onclick="WdatePicker({el:'buildTime','skin':'YcloudRed'})" src="static/js/skin/datePicker.gif" width="16" height="22" align="absmiddle">
	</td>
</tr>
...
<td height="28" colspan=4 align=center>
	...
	<a href="bx/myList" class="coolbg">返回</a>
</td>
</tr>
</table>
